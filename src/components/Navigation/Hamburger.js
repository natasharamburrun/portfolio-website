      ...
      <div className="logo">
        <a href="/" className="logo">
         ...
         <div className="navbar-burger">
            {navbarOpen ?
              <button onClick={clickHamburger}className="navbar-close" aria-label="menu to close navbar"  aria-expanded="true">
               ...
               <button onClick={clickHamburger} className="navbar-hamburger"   aria-label="menu to open navbar">
